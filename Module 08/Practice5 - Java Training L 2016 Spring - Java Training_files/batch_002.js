...
Confluence.Templates.CreateSpace.createPersonalSpaceForm = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<form action="', soy.$$escapeHtml("/conf2"), '/spaces/docreatepersonalspace.action" method="post" class="aui" id="create-personal-space-form"><p>', "Your personal space is your own private workspace within Confluence. You can optionally let other people view or contribute to it.", '</p>');
  Confluence.Templates.CreateSpace.spaceFormPermissions(opt_data, output);
  output.append('<input type="hidden" name="atl_token" value="', soy.$$escapeHtml(opt_data.atlToken), '" />');
  if (opt_data.buttons) {
    Confluence.Templates.CreateSpace.spaceFormButtons(null, output);
...
Confluence.Templates.CreateSpace.spaceFormButtons = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div class="buttons-container"><div class="buttons"><input name="create" class="button button-panel-submit-button" type="submit" value="', soy.$$escapeHtml("Create"), '" /><a href="', soy.$$escapeHtml("/conf2"), '/dashboard.action">', soy.$$escapeHtml("Cancel"), '</a></div></div>');
  return opt_sb ? '' : output.toString();
};
